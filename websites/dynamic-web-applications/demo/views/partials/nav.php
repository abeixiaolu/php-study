<nav class="bg-gray-800">
      ...
      <div class="flex items-center">
        ...
        <div class="hidden md:block">
          <div class="ml-10 flex items-baseline space-x-4">
            ...
            <a href="/about" class="rounded-md px-3 py-2 text-sm font-medium <?= urlIs('/about.php') ? 'text-white bg-gray-900' : 'text-gray-300 hover:bg-gray-700 hover:text-white' ?>">About</a>
            <a href="/contact" class="rounded-md px-3 py-2 text-sm font-medium <?= urlIs('/contact.php') ? 'text-white bg-gray-900' : 'text-gray-300 hover:bg-gray-700 hover:text-white' ?>">Contact</a>
            <a href="/notes" class="rounded-md px-3 py-2 text-sm font-medium <?= urlIs('/notes.php') ? 'text-white bg-gray-900' : 'text-gray-300 hover:bg-gray-700 hover:text-white' ?>">Notes</a>
          </div>
        </div>
      </div>
      <div class="hidden md:block">
  ...
  <div class="md:hidden" id="mobile-menu">
    <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
      ...
      <a href="/about.php" class="block rounded-md bg-gray-900 px-3 py-2 text-base font-medium text-white" aria-current="page">About</a>
